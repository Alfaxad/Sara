        ...
        {isLoading && artifacts.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-body-small text-sara-text-muted">
              FHIR resources, traces, and summaries will appear here
            </p>
          </div>
        ) : (
          <div className="space-y-4" role="list" aria-label="Retrieved clinical artifacts">
...
export function ChatPageClient({ taskId }: ChatPageClientProps) {
  const {
    task,
    messages,
    artifacts,
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-sara-bg-base" role="main">
        <div className="text-center animate-fade-up">
          ...
          <Link href="/" className="sara-btn sara-btn-primary">
            Back to Tasks
          </Link>
        </div>
      </div>
